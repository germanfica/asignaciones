...
class TaskController extends Controller
{
    ...
    public function addAction()
    {
        ...
        return $this->render('EMMUserBundle:Task:add.html.twig', array(
    ...
    public function viewAction($id)
    {
        ...
        $user = $task->getUser();
        return $this->render('EMMUserBundle:Task:view.html.twig', array('task' => $task, 'user' => $user,
    ...
    public function editAction($id)
    {
      ...
      return $this->render('EMMUserBundle:Task:edit.html.twig', array('form' => $form->createView()));
    }
